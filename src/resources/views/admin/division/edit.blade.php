@extends('layout.app')
@section('title', "Обновление подразделения $division->title")
@section('content')
    <section>
        <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Обновление подразделения | {{ $division->title }}</h2>
